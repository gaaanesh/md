...
function formatDockerBinariesIssues(dockerBinariesSortedGroupedVulns, binariesVulns, options) {
    ...
    var _loop_1 = function (pkgInfo) {
        ...
        var binaryIssues = dockerBinariesSortedGroupedVulns.filter(function (vuln) {
...
function createFixedInText(versionRangeList, pkgVersion) {
    ...
    if (!pkgVersion) {
        ...
        for (var _i = 0, versionRangeList_1 = versionRangeList; _i < versionRangeList_1.length; _i++) {
            var versionRange = versionRangeList_1[_i];
